...
export function BottomToolbar() {
  const { addElement, activeTool, setTool, drawColor, setDrawColor, drawThickness, setDrawThickness, userId } =
    useFolioStore();
  ...
  const addShape = (variant: 'rectangle' | 'circle' | 'line' | 'arrow') => {
    addElement({
      ...
      width: 120,
      height: variant === 'line' || variant === 'arrow' ? 40 : 120,
      rotation: 0,
  ...
  return (
    <div
      className="h-14 flex items-center gap-1 px-4 border-t overflow-x-auto toolbar-scroll"
    ...
    >
      ...
      <div className="flex items-center gap-1 mx-auto shrink-0">
        ...
        <div className="w-px h-8 mx-1 shrink-0" style={{ backgroundColor: '#2a2a2a' }} />

        <button onClick={handlePhotoClick} className="toolbar-btn">
